...
class SearchResult:
    ...
    text: str
    score: float
    def __init__(self, evi_id, docid, title, text, score):
        self.evi_id = evi_id
        self.docid = docid
        self.title = title
        self.text = text
    ...
    def to_dict(self):
        return {"evi_id": self.evi_id, "docid": self.docid, "title": self.title, "text": self.text, "score": self.score}
...
def postprocess_answers_closed(output, task=None, choices=None):
    final_output = None
